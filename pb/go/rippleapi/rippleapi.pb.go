...
type ResponseSubmitTransaction struct {
	...
	EarliestLedgerVersion uint32 `protobuf:"varint,2,opt,name=earliestLedgerVersion,proto3" json:"earliestLedgerVersion,omitempty"`
}
...
func (m *ResponseSubmitTransaction) GetEarliestLedgerVersion() uint32 {
	if m != nil {
...
type ResponseWaitValidation struct {
	LedgerVersion uint32 `protobuf:"varint,1,opt,name=ledgerVersion,proto3" json:"ledgerVersion,omitempty"`
}
...
func (m *ResponseWaitValidation) GetLedgerVersion() uint32 {
	if m != nil {
...
type RequestGetTransaction struct {
	TxID             string `protobuf:"bytes,1,opt,name=txID,proto3" json:"txID,omitempty"`
	MinLedgerVersion uint32 `protobuf:"varint,2,opt,name=minLedgerVersion,proto3" json:"minLedgerVersion,omitempty"`
}
...
func (m *RequestGetTransaction) GetMinLedgerVersion() uint32 {
	if m != nil {
...
var fileDescriptor_294224101de536c3 = []byte{
	...
	0x10, 0xb7, 0x43, 0x96, 0xdd, 0xcc, 0x02, 0x71, 0xde, 0x36, 0x84, 0xb0, 0xad, 0x95, 0x75, 0x53,
	...
	,
	...
	0x77, 0x8b, 0xbf, 0x2c, 0xbd, 0xac, 0xef, 0xff, 0xfa, 0xbf, 0x00, 0x00, 0x00, 0xff, 0xff, 0xf6,
	0xee, 0x45, 0x93, 0xe1, 0x08, 0x00, 0x00,
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EarliestLedgerVersion |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinLedgerVersion |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
